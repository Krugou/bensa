            ...
            {isDevMode && (
              <div className="mt-6 flex flex-col items-center gap-2">
                <a
                  ...
                  className="px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:text-white transition-all duration-300 flex items-center gap-2 text-[10px] font-bold"
                >
