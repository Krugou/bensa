...
export const Header = () => {
  ...
  return (
    <header className="text-center py-8 md:py-12 animate-fade-in">
      ...
      {/* Subtitle */}
      <p className="text-slate-500 dark:text-white/50 font-mono text-sm md:text-base tracking-wider uppercase">
      ...
      <div className="mt-6 relative overflow-hidden h-8 border-y border-slate-200 dark:border-white/[0.06]">
        <div className="animate-marquee whitespace-nowrap flex items-center h-full gap-8 text-xs font-mono text-slate-500 dark:text-white/40">
